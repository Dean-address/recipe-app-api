...
class PrivateTagApiTests(TestCase):
    ...
    def test_retrieve_tags(self):
        ...
        Tag.objects.create(user=self.user, name="Tag name1")
        Tag.objects.create(user=self.user, name="Tag name2")
        res = self.client.get(TAG_URL)
    ...
    def test_tags_limited_to_user(self):
        ...
        Tag.objects.create(user=user2, name="Tag name 2")

        tag = Tag.objects.create(user=self.user, name="Tag name auth")
        res = self.client.get(TAG_URL)
